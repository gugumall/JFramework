...
public class NongLi {
	...
	public static int[] lundarToSolar(int year,int month,int day){
		String[] s=NongLi.sCalendarLundarToSolar(year,month,day);
	...
	public static int[] solarToLundar(int year,int month,int day){
		String[] s=NongLi.sCalendarSolarToLundar(year,month,day);
		return new int[]{Integer.parseInt(s[0]),Integer.parseInt(s[1]),Integer.parseInt(s[2])};
	}
	...
	// 29 days
	private static final int[] iLunarMonthDaysTable = { 0x4ae0, 0xa570, 0x5268,
			0xd260, 0xd950, 0x6aa8, 0x56a0, 0x9ad0, 0x4ae8, 0x4ae0, // 1910
	...
	private static int iGetLLeapMonth(int iYear) {
