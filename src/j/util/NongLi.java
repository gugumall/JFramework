...
public class NongLi {
	 ...
	 * @return
	 */
	public static int[] _solarToLunar(long time){
		return solarToLunar(JUtilTimestamp.getValue(time, Calendar.YEAR),
				JUtilTimestamp.getValue(time, Calendar.MONTH)+1,
				JUtilTimestamp.getValue(time, Calendar.DAY_OF_MONTH));
	}
	...
	public static void main(String[] args) {
		System.out.println(Arrays.toString(solarToLunar(1980, 6, 28)));
		System.out.println(Arrays.toString(_solarToLunar(System.currentTimeMillis())));
		System.out.println(Arrays.toString(NongLi.lunarToSolar(1980, 5, 16, false)));
		System.out.println(Arrays.toString(NongLi.lunarToSolar(2019, 7, 16, false)));
	}
}