...
public class GoogleAuthenticator { 
     ...
     * @param codes
     * @param savedSecret
     * @param timeWindowSizeSecs 最大可偏移时间窗口（秒）
     * @return
     */
    public static Boolean checkCode(String codes, String savedSecret,int timeWindowSizeSecs) {
        ...
        ga.setWindowSize(timeWindowSizeSecs);
   ...
   public static String getQRBarcodeURL(String user, String host, String secret) {
        ...
        return String.format(format, user, user, secret, user);
    }
    ...
    */
    ...
    public static void main(String[] args) {
    	String s="GDEUJKGXY3S4YBRP";//GoogleAuthenticator.generateSecretKey();
    	System.out.println(s);
    	
    	//var code = 'otpauth://totp/wwaa221:wwaa221?secret=SE5C4KNUCS4GOSQH&issuer=wwaa221';
    	
    	Boolean ok=GoogleAuthenticator.checkCode("521029", s, 0);
    	System.out.println(ok);
    	
    	System.out.println(getQRBarcodeURL("aaabbb","aaa.com",s));
    }
} 