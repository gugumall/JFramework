...
import j.dao.connection.helper.StringHelper;
...
public class ProxoolConnectionProvider implements ConnectionProvider {
	...
	// TRUE if the pool is borrowed from the outside, FALSE if we used to create
	// it
	...
	public void close() throws Exception {
		...
		try {
			...
			throw new Exception("Exception occured when closing the Proxool pool", e);
		}
	}
}
