...
import j.dao.connection.Environment;
...
public final class NamingHelper {
	...
	/**
	 * Transform JNDI properties passed in the form <tt>hibernate.jndi.*</tt>
	 * to the format accepted by <tt>InitialContext</tt> by triming the
	 * leading "<tt>hibernate.jndi</tt>".
	 */
